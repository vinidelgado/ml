...
data class MLSearchProduct(
    @SerializedName("site_id") val siteId: String,
    @SerializedName("country_default_time_zone") val countryDefaultTimeZone: String,
    @SerializedName("query") val query: String,
    @SerializedName("paging") val paging: MLPaging,
    @SerializedName("results") val results: List<MLProduct>,
    @SerializedName("sort") val sort: MLSort,
    @SerializedName("available_sorts") val availableSorts: List<MLSort>,
    @SerializedName("filters") val filters: List<MLFilter>,
...
//    @SerializedName("shipping") val shipping: MLShipping?,
...
//    @SerializedName("installments") val installments: MLInstallments?,
